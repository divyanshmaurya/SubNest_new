...
- After calling updateLeadInfo, acknowledge the user's answer in 1 short sentence, then ask ONLY the ONE question for the current stage, then STOP. Do NOT skip ahead or combine stages.
