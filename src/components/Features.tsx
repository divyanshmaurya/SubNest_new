        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {features.map((f, i) => (
            ...
            >
              ...
              <div className="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center mb-8 group-hover:rotate-6 transition-transform border border-slate-100">
                {f.icon}
              </div>
